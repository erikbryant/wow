...
var (
	...
	realms     = flag.String("realms", "Aegwynn,Akama,Altar of Storms,Andorhal,Anub'arak,Argent Dawn,Azgalor,Azuremyst,Baelgun,Blackwing Lair,Bloodhoof,Bronzebeard,Cairne,Drak'thul,Eitrigg,Farstriders,Ghostlands,Greymane,IceCrown,Kul Tiras", "WoW realms")
